...
public class PaymentApp {
    ...
    public static void main(String[] args) {
        ...
        app.routes(() -> {
            post("pay/{user_id}/{order_id}/{amount}", ctx -> ctx.json(api.pay(ctx.pathParam("user_id"), ctx.pathParam("order_id"), Float.parseFloat(ctx.pathParam("amount")))));
            ...
            post("add_funds/{user_id}/{amount}", ctx -> ctx.json(api.addFunds(ctx.pathParam("user_id"), Float.parseFloat(ctx.pathParam("amount")))));
